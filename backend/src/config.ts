...
export const config = {
  ...
  solTeamWallet: new PublicKey(required("SOL_TEAM_WALLET")),
  solDevBuybackWallet: new PublicKey(required("SOL_DEV_BUYBACK_WALLET")),
  solHolderRewardsWallet: new PublicKey(required("SOL_HOLDER_REWARDS_WALLET")),
  tokenTeamFeeAccount: new PublicKey(required("TOKEN_TEAM_FEE_ACCOUNT")),
